...
<div style="display: flex; flex-direction: row;">
    <div style="flex: 1;">
        <img src="https://pieroromare.github.io/assets/img/proiem.png" alt="Proiem" width="300">
    </div>
    <div style="flex: 2; margin-left: 20px;">
        <h4>Proiem</h4>
        <h7>
        During the years of high school I started a online shop. I was a reseller of streetwear brands including <a href="https://eu.supreme.com">Supreme</a>, <a href="https://www.palaceskateboards.com">Palace</a>, <a href="https://eu.stussy.com">Stussy</a>, <a href="https://hufworldwide.eu">Huf</a>, <a href="https://obeyclothing.eu">Obey</a>. I experimented with coding as a self-teacher to build the website and the recommendation system. I closed it after 2 years because I had to focus on my studies at the university.
        My friend Filippo helped me with the logo.
        </h7>
    </div>
</div>
...
<div style="display: flex; flex-direction: row;">
    <div style="flex: 1;">
        <img src="https://pieroromare.github.io/assets/img/peterniemi.png" alt="Peter Niemi" width="200" height="150">
    </div>
    <div style="flex: 2;">
        <h4>Music</h4>
        <h7>
        I have always been passionate about music. I started around the end of middle school and I ran a techno project alone under the name of <a href="https://soundcloud.com/peter-niemi">Peter Niemi</a>. A few embarrassing songs should still be on Spotify.
        </h7>
    </div>
</div>
...
<div style="display: flex; flex-direction: row;">
    <div style="flex: 2;">
        ...
        Together with my friend Andrea who played the electronic drums, we played a few times live using the name ThElements of Live.
        </h7>
    </div>
    <div style="flex: 1;">
        <img src="https://pieroromare.github.io/assets/img/thelementsoflive.png" alt="ThElements of Live" width="250">
    </div>
</div>
...
<div style="display: flex; flex-direction: row;">
    <div style="flex: 1;">
        <img src="https://pieroromare.github.io/assets/img/peterhall.png" alt="Batcaverna" width="200">
    </div>
    <div style="flex: 2;">
        <h7>
        More than 10 years ago, with my friends Filippo, Federico, and Andrea, we created a <a href="https://www.youtube.com/@peterhalltv">YouTube channel</a> called Peter Hall Tv.
        During that time, we streamed online techno music. We were one of the first to do it in Italy thanks also to Youtube which at that time did not ask for a certain amount of subscribers to allow the streaming. We streamed every two weeks, on Sunday evenings, by hosting several DJs from our city.
        </h7>
    </div>
</div>
<br>
<div style="display: flex; flex-direction: row;">
    ...
    <div style="flex: 1;">
        <img src="https://pieroromare.github.io/assets/img/peterhall2.png" alt="Peter Hall" width="200">
        <img src="https://pieroromare.github.io/assets/img/peterhall3.png" alt="Peter Hall" width="200">
    </div>
</div>